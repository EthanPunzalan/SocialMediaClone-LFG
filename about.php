    ...
    <div class="mainContainer">
        ...
        <div class="postFeed_container" style="text-align:center;">
            <h2 style="color:white; font-weight:100; font-size:3rem">
                LFG or Looking for group, is made to connect with others. Just like most social medias, it can be used several purposes.
                They way LFG works is that you can post whatever you want to say in order to look for a group, either to play with or 
                just to have a chat with. <br>            
            </h2>
        </div>
    </div>
</body>
