<?php
    ...
    if(mysqli_num_rows($res) > 0){
            $result=mysqli_query($db,"SELECT * FROM posts order by likes DESC");
...
?>
        <div class="likeBox">
            ...
            <a class="likeLabel" href="includes/trendingLikes.inc.php?id=<?php echo $row['id']?>"><i class="fas fa-arrow-up"></i></a>
        </div>
        <div class="dislikeBox">
            <p class="dislikes"><?php echo $row['dislikes']?></p>
            <a class="dislikeLabel" href="includes/trendingDislikes.inc.php?id=<?php echo $row['id']?>"><i class="fas fa-arrow-down"></i></a>
        </div>
